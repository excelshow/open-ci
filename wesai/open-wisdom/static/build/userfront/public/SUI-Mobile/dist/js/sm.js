...
+ function($) {
    ...
    var Scroller = function(pageContent, _options) {
        ...
        var probeType = this.options.probeType ? this.options.probeType : 1;

        var userTransform = this.options.userTransform ? this.options.userTransform : 0;
        ...
        if (useJSScroller) {
            ...
            var useTransform = $pageContent.find('.fixed-tab').length === userTransform;
            var options = {
                probeType: probeType,
                mouseWheel: true,
