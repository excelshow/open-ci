...
(function(){
    ...
    UM.registerWidget( widgetName,{
        ...
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=video_url%>video.css\" />" +
            ...
            "<table><tr><td><label for=\"eduiVideoUrl\" class=\"edui-video-url\"><%=lang_video_url%></label></td><td><textarea id=\"eduiVideoUrl\" style=\"height:137px;\" placeholder=\"请粘贴视频分享通用代码，通用代码可以让你的视频在iPhone、iPad上播放！为了适配不同的设备，请将代码的width属性改为100%，height属性改为300\"></textarea></td></tr></table>" +
            "<div id=\"eduiVideoPreview\" style=\"display:block;width:570px;min-height:180px;overflow:auto;text-align: center\"></div>" +
            "<div id=\"eduiVideoInfo\" style=\"display:none\">" +
            "<fieldset>" +
