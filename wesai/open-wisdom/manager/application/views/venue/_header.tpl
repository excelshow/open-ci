...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{'manager/venue/css/main.css'|cdnurl}">
    <link rel="stylesheet" type="text/css" href="{'manager/venue/css/style.css'|cdnurl}">
    <!--[if lt IE 9]>
    ...
    <script src="{'manager/venue/js/_api.js'|cdnurl}"></script>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                ...
                <li role="/operation/market/market" class=""><a href="/operation/market/activity_list">营销中心</a></li>
