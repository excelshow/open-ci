 ...
 */
//上架
define('VENUE_STATE_UP', 3);
//上架中
define('VENUE_STATE_UPING', 2);
//下架
define('VENUE_STATE_DOWN', 1);


/* 场馆区域资源状态 */
define('VENUE_AREA_RES_STATE_UNSHELVE', 1); // 下架
define('VENUE_AREA_RES_STATE_SHELEVING', 2); // 上架中
define('VENUE_AREA_RES_STATE_SHELVE', 3); //  上架
define('VENUE_AREA_RES_STATE_CAN_SELL', 4); //  可售

/* 场馆区域 */
define('VENUE_NAME_MAX_LENGTH', 200); // 场馆名称最大长度
define('VENUE_ADDRESS_MAX_LENGTH', 200); // 场馆地址详情最大长度
define('VENUE_INTRO_MAX_LENGTH', 6000); // 场馆图文信息最大长度

defined('DAY_TYPE_WEEKDAY')		OR define('DAY_TYPE_WEEKDAY', 1); // 工作日
defined('DAY_TYPE_WEEKEND')		OR define('DAY_TYPE_WEEKEND', 2); // 周末
defined('DAY_TYPE_HOLIDAY')		OR define('DAY_TYPE_HOLIDAY', 3); // 节假日

// 已使用
define('ORDER_IS_USE', 1);
// 未使用
define('ORDER_IS_NO_USE', 2);
 ...
 */
//	活动状态 暂存
define('OPERATION_ACTIVITY_STATE_STOP', '1'); 
//	活动状态 上架
define('OPERATION_ACTIVITY_STATE_START', '2');
//	活动状态 下架
define('OPERATION_ACTIVITY_STATE_DOWN', '3');
//	活动状态 结束
define('OPERATION_ACTIVITY_STATE_END', '4');
$OPERATION_ACTIVITY_STATE = array(
    OPERATION_ACTIVITY_STATE_STOP => '暂存 ',
    OPERATION_ACTIVITY_STATE_START => '上架',
    OPERATION_ACTIVITY_STATE_DOWN => '下架 ',
    OPERATION_ACTIVITY_STATE_END => '结束 ',
);

//代金券code头
define('OPERATION_VOUCHER_CODE', '60');

//	代金券 状态 已生成未分配
define('OPERATION_VOUCHER_STATE_NOTALLOT', '1');
//	代金券 状态 已分配未使用
define('OPERATION_VOUCHER_STATE_NOTUSE', '2');
//	代金券 状态 已使用
define('OPERATION_VOUCHER_STATE_USE', '3');
//	代金券 状态 销毁
define('OPERATION_VOUCHER_STATE_CANCEL', '4');
//	代金券 状态 过期
define('OPERATION_VOUCHER_STATE_OVERDUE', '5');
$OPERATION_VOUCHER_STATE = array(
    OPERATION_VOUCHER_STATE_NOTALLOT => '已生成 ',
    OPERATION_VOUCHER_STATE_NOTUSE => '未使用',
    OPERATION_VOUCHER_STATE_USE => '已使用 ',
    OPERATION_VOUCHER_STATE_CANCEL => '已废弃 ',
    OPERATION_VOUCHER_STATE_OVERDUE => '已过期',
);

// 代金券规则 状态 未审批
define('OPERATION_VOUCHER_RULE_STATE_NOSUBJECT', '1');
// 代金券规则 状态 待审批
define('OPERATION_VOUCHER_RULE_STATE_WAIT', '2');
// 代金券规则 状态 通过
define('OPERATION_VOUCHER_RULE_STATE_PASSED', '3');
// 代金券规则 状态 不通过
define('OPERATION_VOUCHER_RULE_STATE_NOTPASSED', '4');
// 代金券规则 状态 生成中
define('OPERATION_VOUCHER_RULE_STATE_GENERATING', '5');
// 代金券规则 状态 已生成
define('OPERATION_VOUCHER_RULE_STATE_GENERATED', '6'); 
// 代金券规则 状态 作废
define('OPERATION_VOUCHER_RULE_STATE_CANCEL', '7');
// 代金券规则 状态 作废完成
define('OPERATION_VOUCHER_RULE_STATE_CANCEL_FINISH', '8');
// 代金券规则 状态 过期
define('OPERATION_VOUCHER_RULE_STATE_OVERDUE', '9');
$OPERATION_VOUCHER_RULE_STATE = array(
    OPERATION_VOUCHER_RULE_STATE_NOSUBJECT => '未审核',
    OPERATION_VOUCHER_RULE_STATE_WAIT => '待审核',
    OPERATION_VOUCHER_RULE_STATE_PASSED => '审核通过',
    OPERATION_VOUCHER_RULE_STATE_NOTPASSED => '审核未通过',
    OPERATION_VOUCHER_RULE_STATE_GENERATING => '生成中',
    OPERATION_VOUCHER_RULE_STATE_GENERATED => '已生成',
    OPERATION_VOUCHER_RULE_STATE_CANCEL => '作废',
    OPERATION_VOUCHER_RULE_STATE_CANCEL_FINISH => '作废完成',
    OPERATION_VOUCHER_RULE_STATE_OVERDUE => '已过期',
);
