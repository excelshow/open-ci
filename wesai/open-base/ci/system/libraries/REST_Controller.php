...
abstract class Rest_Controller extends CI_Controller
{
     ...
     * add by xumenghe@wefit.com.cn
     * @var boolean
     */
    protected $_exists_controller_method       = true;
    ...
    */
    ...
    protected $_supported_formats   = array(
        ...
        //'php'           => 'text/plain', // bug，参数里面有.php 的也会匹配到 @2016-11-08 @like
        'html'          => 'text/html',
        'csv'           => 'application/csv'
    );
    ...
    public function _remap($object_called, $arguments)
    {
        ...
        if ( ! method_exists($this, $controller_method)) {
            $this->_exists_controller_method = false;
            show_404();
    ...
    public function response($data = null, $http_code = null, $continue = false)
    {
        ...
        // Otherwise (if no data but 200 provided) or some data, carry on camping!
            ...
            if ($this->_exists_controller_method) {
                // 计算cost值
                // add by xumenghe@wefit.com.cn
                // @see http://wiki.wefit.com.cn/dev:define:api_spec#返回值对象结构
                $data = $this->api_spec->calcu_cost($this->_start_rtime);
            }
